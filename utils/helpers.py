...
def create_map():
    lines_data = load_geojson(f"{GITHUB_BASE}/images/railway/railways_lines.geojson")
    points_data = load_geojson(f"{GITHUB_BASE}/images/railway/railways_points.geojson")
