...
st.markdown("Explore India's cultural treasures. Scroll and click on each point to learn about its visitors and growth.")
...
selected_states = st.multiselect("🎯 Choose State(s) to Display Monuments:", sorted(states))

# Filter dataset based on selected states
if selected_states:
    filtered_df = df[df['state'].isin(selected_states)]
else:
    filtered_df = df  # Show all if none selected
